...
let modalQt = 0;
let key = 0;
//constante para carregar estrutura
const c = (el)=>document.querySelector(el); //localizar o primeiro item
const cs = (el)=>document.querySelectorAll(el); //localizar todos os itens
